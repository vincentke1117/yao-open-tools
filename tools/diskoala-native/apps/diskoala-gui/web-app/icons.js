// Scai 内联图标（Lucide 线性风格，24 viewBox，离线使用）
(function () {
  const P = {
    ...
    sparkles: '<path d="M9.94 15.5a2 2 0 0 0-1.44-1.44L2.37 12.5a.5.5 0 0 1 0-.96L8.5 9.94a2 2 0 0 0 1.44-1.44l1.56-6.13a.5.5 0 0 1 .96 0l1.56 6.13a2 2 0 0 0 1.44 1.44l6.13 1.56a.5.5 0 0 1 0 .96l-6.13 1.56a2 2 0 0 0-1.44 1.44l-1.56 6.13a.5.5 0 0 1-.96 0z"/>',
    copy: '<rect width="14" height="14" x="8" y="8" rx="2"/><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"/>',
    scroll: '<path d="M19 17V5a2 2 0 0 0-2-2H4"/><path d="M8 21h12a2 2 0 0 0 2-2v-1a1 1 0 0 0-1-1H11a1 1 0 0 0-1 1v1a2 2 0 1 1-4 0V5a2 2 0 1 0-4 0v2a1 1 0 0 0 1 1h3"/><path d="M15 12h-5"/><path d="M15 8h-5"/>',
  ...
  window.scaiIcon = function (name, size) {
    const s = size || 16;
  ...
  document.querySelectorAll('[data-icon]').forEach((el) => {
    el.innerHTML = window.scaiIcon(el.dataset.icon);
  });
})();
